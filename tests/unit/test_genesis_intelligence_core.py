...
class GenesisToolRouterTests(unittest.TestCase):
    def test_agent_router_classifies_general_intents_without_fake_tickers(self) -> None:
        ...
        opportunity_route = router.route("que hay para comprar?")
        self.assertEqual(opportunity_route.intent, "opportunities")
        self.assertEqual(opportunity_route.tickers, [])
        self.assertEqual(opportunity_route.primary_ticker, "")
