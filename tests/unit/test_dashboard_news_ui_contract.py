...
class DashboardNewsUiContractTests(unittest.TestCase):
    ...
    def test_dashboard_script_has_clean_spanish_encoding(self) -> None:
        ...
        self.assertIn("Bitcoin: cierre de mayo", script)
        self.assertIn("Bienes ra\\u00edces frente", script)
        self.assertIn("confirmar\\u00eda mercado alcista", script)
    ...
    def test_alerts_have_opportunity_scanner_and_visual_strategy_contract(self) -> None:
        ...
        self.assertIn("function opportunityValidationParts", script)
        self.assertIn("opportunity-playbook", script)
        self.assertIn("indicator-chips", script)
        self.assertIn("Entrada", script)
        self.assertIn("Invalida", script)
