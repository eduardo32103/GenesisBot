...
class MT5PersistentIntelligenceBootstrapTests(unittest.TestCase):
    def test_bootstrap_seeds_current_knowledge_once_and_then_skips_existing(self) -> None:
        ...
        self.assertEqual(first["seeded_research_lesson_rows"], 6)
        self.assertGreaterEqual(first["seeded_strategy_rows"], 6)
        ...
        self.assertEqual(len(store.tables["mt5_research_lessons"]), 6)
