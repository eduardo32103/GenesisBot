...
class DashboardMoneyFlowWebIntegrationTests(unittest.TestCase):
    def test_real_dashboard_static_files_move_ballenas_inside_alerts_and_expose_news(self) -> None:
        ...
        self.assertIn('getJson("/api/dashboard/money-flow/causal"', script)
        self.assertIn("getJson(`/api/dashboard/money-flow/jarvis?q=", script)
        self.assertIn("API_FALLBACK_ORIGIN", script)
