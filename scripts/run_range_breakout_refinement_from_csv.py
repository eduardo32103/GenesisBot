...
from services.mt5.mt5_range_breakout_refinement import (  # noqa: E402
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run MT5 M30 range breakout anti-chop exit/cluster refinement from CSV.")
    ...
    parser.add_argument("--smoke", action="store_true", help="Run a small bounded refinement pass.")
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.smoke:
        args.targets = "m30_range_breakout_both_all,range_breakout_anti_chop_m30_no_offsession_v2"
    ...
    csv_path, json_path, summary_path = write_range_breakout_refinement_outputs(result, args.output_dir)
