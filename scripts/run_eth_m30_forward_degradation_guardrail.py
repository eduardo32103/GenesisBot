...
def _human_summary(result: dict[str, Any]) -> str:
    lines = [
        ...
        f"degradation_guardrail_active={result.get('degradation_guardrail_active')}",
        f"pending_degradation_until_shadow_closes={result.get('pending_degradation_until_shadow_closes')}",
        f"paper_probe_allowed={result.get('paper_probe_allowed')}",
