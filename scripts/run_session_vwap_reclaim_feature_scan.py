...
def _human_summary(result: dict[str, Any]) -> str:
    lines = [
        "MT5 session VWAP reclaim feature scan",
...
def _parse_args(argv: list[str] | None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Fast offline session VWAP reclaim feature scan.")
    ...
    parser.add_argument("--timeframes", default="", help="Comma-separated timeframes. Defaults to M15,M30,H1.")
