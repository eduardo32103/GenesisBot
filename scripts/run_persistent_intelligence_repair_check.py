...
def run_repair_check(
    *,
    ...
    return {
        ...
        "failed_writes_total": healthcheck.get("failed_writes_total"),
        "failed_writes_active": healthcheck.get("failed_writes_active"),
        "failed_writes_unresolved": healthcheck.get("failed_writes_unresolved"),
        "failed_writes_critical": healthcheck.get("failed_writes_critical"),
        "failed_write_semantics_known": healthcheck.get("failed_write_semantics_known"),
        "queued_writes": healthcheck.get("queued_writes"),
        "dropped_noncritical_writes": healthcheck.get("dropped_noncritical_writes"),
        "dropped_noncritical_writes_total": healthcheck.get("dropped_noncritical_writes_total"),
        "suppressed_duplicate_events": healthcheck.get("suppressed_duplicate_events"),
        "last_db_error_category": last_category,
        "db_readiness_blocking_reason": healthcheck.get("db_readiness_blocking_reason"),
