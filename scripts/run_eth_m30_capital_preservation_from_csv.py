...
from services.mt5.mt5_eth_m30_capital_preservation import (  # noqa: E402
...
def parse_args(argv: list[str] | None = None) -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run ETHUSD M30 capital preservation validation from local CSV.")
    ...
    parser.add_argument("--monte-carlo-simulations", type=int, default=1200)
...
def main(argv: list[str] | None = None) -> int:
    ...
    if args.smoke:
        ...
        args.targets = ",".join(ETH_M30_CAPITAL_TARGETS)
    ...
    csv_path, json_path, summary_path = write_eth_m30_capital_preservation_outputs(result, args.output_dir)
    ...
    print(f"Passed: {len(result.get('passed') or [])}")
    ...
    print("promoted_profile_mutated=false")
    print("forward_state_mutated=false")
