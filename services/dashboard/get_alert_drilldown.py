...
def _snapshot_alert_detail(alert_id: str) -> dict[str, Any]:
    ...
    for item in snapshot.get("items") or snapshot.get("recent_alerts") or []:
        ...
        return {
            ...
            "daily_change": item.get("daily_change") or item.get("change"),
            "daily_change_pct": item.get("daily_change_pct") or item.get("change_pct"),
            ...
            "genesis_reading_es": item.get("genesis_reading_es") or item.get("genesis_reading") or "",
            "what_it_means": item.get("what_it_means") or item.get("summary") or "",
            "what_happened_es": item.get("what_happened_es") or item.get("summary") or item.get("description") or "",
            "why_it_matters_es": item.get("why_it_matters_es") or item.get("what_it_means") or "",
            "what_to_watch": item.get("what_to_watch") or "Confirmar con precio, volumen y contexto antes de actuar.",
            "what_to_watch_es": item.get("what_to_watch_es") or item.get("what_to_watch") or "Confirmar con precio, volumen y contexto antes de actuar.",
            "affected_portfolio_assets": item.get("affected_portfolio_assets") or ([item.get("ticker")] if item.get("ticker") else []),
            "affected_watchlist_assets": item.get("affected_watchlist_assets") or ([item.get("ticker")] if item.get("ticker") else []),
