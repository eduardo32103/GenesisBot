...
def run_persistent_db_doctor(
    *,
    ...
    return {
        ...
        "failed_writes_total": int(effective.get("failed_writes_total") or effective.get("failed_writes") or 0),
        "failed_writes_active": int(effective.get("failed_writes_active") or 0),
        "failed_writes_unresolved": int(effective.get("failed_writes_unresolved") or 0),
        "failed_writes_critical": int(effective.get("failed_writes_critical") or 0),
        "failed_write_semantics_known": bool(effective.get("failed_write_semantics_known")),
        ...
        "dropped_noncritical_writes_total": int(effective.get("dropped_noncritical_writes_total") or effective.get("dropped_noncritical_writes") or 0),
        "last_db_error_category": str(effective.get("last_db_error_category") or diagnostics.get("error_category") or ""),
        "db_readiness_blocking_reason": str(effective.get("db_readiness_blocking_reason") or ""),
